...
def bdreg(B, N=None, VamModel=None, BuildModel=None):
    ...
    if BuildModel:
        ...
        bdrn = VamModel['bdrn']
    # end = time.time()
    # print('For resample of bdreg, elapsed time is ' + str(end - start) + 'seconds...')
    ...
    # end = time.time()
    # print('For registration of bdreg, elapsed time is ' + str(end - start) + 'seconds...')
